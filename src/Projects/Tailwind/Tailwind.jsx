...
const Tailwind = () => {
  return (
    <div>
      <button className="bg-green-400 text-black p-4 rounded-xl w-64 h-13 font-bold mb-10">
        Tailwind
      </button>
      ...
      <div class="flex font-sans">
        <div class="flex-none w-48 relative">
          <img
            src="https://www.montecarlo.in/cdn/shop/products/223061830-2-38_5.jpg?v=1702638396&width=1100"
            alt=""
